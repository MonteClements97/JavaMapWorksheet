...
public class PhoneBookDemo {
    ...
    public PhoneBookDemo(){
        ...
        /**
         * TODO: Instantiate your phone book class here!
         * Simply comment in the first three lines of the following code!
         */
    ...
    private void readPhoneBook(){
        ...
        if(input.startsWith("y")){
            ...
            try {
                ...
                switch (inputFile){
                    case "s":
                        file = new File("C:/Users/Montell/IdeaProjects/Hashing/src/phoneBook-small.txt");
                        break;
                    case "m":
                        file = new File("C:/Users/Montell/IdeaProjects/Hashing/src/phoneBook-medium.txt");
                        break;
                    case "l":
                        file = new File("C:/Users/Montell/IdeaProjects/Hashing/src/phoneBook-large.txt");
                        break;
                    default:
